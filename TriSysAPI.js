...
var TriSysAPI =
{
    ...
    TriSysForWebsites:
    {
        ...
        AgencyUserLoginCredentialsToCRM: 'TN1jMwmNpUSGNnHIiPWRW9970X20aQyW2k2XotIkMQD756u9kQt06IfItrF-h5e8lxhpGYpd6fDJe-Ab2BWoZPSuBR22OZbSPgJn40nr191IVPYF-ku71crBQ5Ls8yKNv7y-l0GaIH5-waeTMxUdOeFGCkaO5Sf-EmF7o9hEEAWz3Gx98dIrhOZGf2Dp4wtntqSmpa2Cjbz3KR8Yh8Kzsg__',


        // Connect to Web Service to obtain a data services key
        Authenticate: function (validateCallbackFunction)
        {
            ...
            var CSecurityControllerAuthenticateTriSysCRMCredentials = {
                'CRMCredentialKey': TriSysAPI.TriSysForWebsites.AgencyUserLoginCredentialsToCRM,
                'AccountType': TriSysCRMCredentialAccountTypeEnum_AgencyVacanciesOnly
            };
            ...
            payloadObject.ErrorHandlerFunction = function (request, status, error)
            {
                alert('TriSysAPI.TriSysForWebsites: ' + status + ": " + error + ". responseText: " + request.responseText);
            };
